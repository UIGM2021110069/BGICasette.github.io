  ...
  <div class="panel-header bg-warning-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-black">
        <!-- judul halaman -->
        <h4 class="page-title text-black"><i class="fas fa-clone mr-2"></i> Jenis Cassette</h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-black"></i></a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a href="?module=jenis" class="text-black">Jenis Cassette</a></li>
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Entri Data Jenis Cassette</div>
      </div>
      <!-- form entri data -->
