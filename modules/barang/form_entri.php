    ...
    <div class="page-inner py-4">
      <div class="page-header text-black">
        ...
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a>Entry</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Entry Data Cassette</div>
      </div>
      <!-- form entri data -->
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback">Nama Cassette tidak boleh kosong.</div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback">Jenis Cassette tidak boleh kosong.</div>
              </div>
