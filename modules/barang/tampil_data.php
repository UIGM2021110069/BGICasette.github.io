  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data Cassette berhasil disimpan.</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data Cassette berhasil diubah.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 3) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data Cassette berhasil dihapus.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 4) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data Cassette tidak bisa dihapus karena sudah tercatat pada Data Transaksi.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        <div class="page-header text-black">
          <!-- judul halaman -->
          <h4 class="page-title text-black"><i class="fas fa-clone mr-2"></i> Cassette</h4>
          <!-- breadcrumbs -->
          <ul class="breadcrumbs">
            <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-black"></i></a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="?module=barang" class="text-black">Cassette</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
        ...
        <div class="ml-md-auto py-2 py-md-0">
          <!-- tombol entri data -->
          <a href="?module=form_entri_barang" class="btn btn-success btn-round">
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul tabel -->
        <div class="card-title">Data Cassette</div>
      </div>
      <div class="card-body">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center">ID Cassette</th>
                <th class="text-center">Nama Cassette</th>
                ...
                <tr>
                  ...
                  <td width="100" class="text-center">
                    <div>
                      ...
                      <!-- tombol ubah data -->
                      <a href="?module=form_ubah_barang&id=<?php echo $data['id_barang']; ?>" class="btn btn-icon btn-round btn-success btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Ubah">
