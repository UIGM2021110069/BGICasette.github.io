  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Ubah Data Cassette</div>
      </div>
      <!-- form ubah data -->
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                <label>ID Cassette <span class="text-danger">*</span></label>
                <input type="text" name="id_barang" class="form-control" value="<?php echo $data['id_barang']; ?>" readonly>
              </div>

              <div class="form-group">
                <label>Nama Cassette <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                <label>Jenis Cassette <span class="text-danger">*</span></label>
