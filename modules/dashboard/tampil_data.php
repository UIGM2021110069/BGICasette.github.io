  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-secondary alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Selamat Datang di Aplikasi Regesiter Elektronik Cassette PT. Bringin Gigantara.</span>
          ...
          <div class="card-body ">
            <div class="row">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  <p class="card-category">Data Cassette</p>
                  <?php
        ...
        <div class="card card-stats card-round">
          <div class="card-body ">
            <div class="row">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  <p class="card-category">Data Cassette Masuk</p>
                  <?php
        ...
        <div class="card card-stats card-round">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  <p class="card-category">Data Cassette Keluar</p>
                  <?php
            ...
            <div class="card-body ">
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers">
                    <p class="card-category">Data Jenis Cassette</p>
                    <?php
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center">Jenis Cassette</th>
