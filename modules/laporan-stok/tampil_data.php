    ...
    <div class="page-inner mt--5">
      ...
      <div class="card">
        ...
        if ($stok == 'Seluruh') { ?>
          ...
          <div class="card-header">
            <!-- judul tabel -->
            <div class="card-title"><i class="fas fa-file-alt mr-2"></i> Laporan Stok Seluruh Cassette</div>
          </div>
          <div class="card-body">
        ...
        // jika filter data stok "Minimum" dipilih
          ...
          <div class="card-header">
            <!-- judul tabel -->
            <div class="card-title"><i class="fas fa-file-alt mr-2"></i> Laporan Stok Cassette yang Mencapai Batas Minimum</div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <!-- tabel untuk menampilkan data dari database -->
