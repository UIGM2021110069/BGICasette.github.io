...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  if ($stok == 'Seluruh') {
    ...
    $html = '<!DOCTYPE html>
            <html>
            <head>
              <title>Laporan Stok Seluruh Cassette</title>
              <link rel="stylesheet" href="../../assets/css/laporan.css">
            </head>
            <body class="text-dark">
              <div class="text-center mb-4">
                <h1>LAPORAN STOK SELURUH CASSETTE</h1>
              </div>
              <hr>
              <div class="mt-4">
    ...
    $dompdf->render();
    // menampilkan file PDF yang dihasilkan ke browser dan berikan nama file "Laporan Stok Seluruh Cassette.pdf"
    $dompdf->stream('Laporan Stok Seluruh Cassette.pdf', array('Attachment' => 0));
  }
  // jika filter data stok "Minimum" dipilih, tampilkan laporan stok barang yang mencapai batas minimum
    ...
    $html = '<!DOCTYPE html>
            <html>
            <head>
              <title>Laporan Stok Cassette Minimum</title>
              <link rel="stylesheet" href="../../assets/css/laporan.css">
            </head>
            <body class="text-dark">
              <div class="text-center mb-4">
                <h1>LAPORAN STOK CASSETTE YANG MENCAPAI BATAS MINIMUM</h1>
              </div>
              <hr>
              <div class="mt-4">
                <table class="table table-bordered" width="100%" cellspacing="0">
    ...
    // mengubah dari HTML menjadi PDF
    $dompdf->render();
    // menampilkan file PDF yang dihasilkan ke browser dan berikan nama file "Laporan Stok Cassette Minimum.pdf"
    $dompdf->stream('Laporan Stok Cassette Minimum.pdf', array('Attachment' => 0));
  }
}
