...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  $html = '<!DOCTYPE html>
          <html>
          <head>
              <title>Laporan Data Cassette Keluar</title>
            <link href="../../assets/css/laporan.css" rel="stylesheet">
          </head>
          <body class="text-dark">
            <div class="text-center">
              <h2>LAPORAN DATA CASSETTE KELUAR</h2>
  ...
  $dompdf->render();
  // menampilkan file PDF yang dihasilkan ke browser dan berikan nama file "Laporan Data Cassette Keluar.pdf"
  $dompdf->stream('Laporan Data Cassette Keluar.pdf', array('Attachment' => 0));
}
