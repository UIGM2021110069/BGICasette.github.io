  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data Cassette keluar berhasil disimpan.</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data Cassette keluar berhasil dihapus.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        <div class="page-header text-black">
          <!-- judul halaman -->
          <h4 class="page-title text-black"><i class="fas fa-sign-out-alt mr-2"></i> Cassette Keluar</h4>
          <!-- breadcrumbs -->
          <ul class="breadcrumbs">
            <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-black"></i></a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="?module=barang_keluar" class="text-black">Cassette Keluar</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul tabel -->
        <div class="card-title">Data Cassette Keluar</div>
      </div>
      <div class="card-body">
