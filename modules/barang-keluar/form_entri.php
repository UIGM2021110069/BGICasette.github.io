  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Entri Data Cassette Keluar</div>
      </div>
      <!-- form entri data -->
      <form action="modules/barang-keluar/proses_entri.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                <label>Cassette <span class="text-danger">*</span></label>
                ...
                <div class="invalid-feedback">Cassette tidak boleh kosong.</div>
              </div>
