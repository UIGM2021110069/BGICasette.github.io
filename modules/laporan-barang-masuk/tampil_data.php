  ...
  <div class="panel-header bg-warning-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-black">
        <!-- judul halaman -->
        <h4 class="page-title text-black"><i class="fas fa-file-import mr-2"></i> Laporan Cassette Masuk</h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a>Cassette Masuk</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="page-inner mt--5">
      <div class="card">
        <div class="card-header">
          <!-- judul form -->
          <div class="card-title">Filter Data Cassette Masuk</div>
        </div>
        <!-- form filter data -->
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> Laporan Data Cassette Masuk Tanggal <strong><?php echo $tanggal_awal; ?></strong> s.d. <strong><?php echo $tanggal_akhir; ?></strong>
          </div>
        </div>
        <div class="card-body">
