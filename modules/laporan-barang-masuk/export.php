...
// jika user sudah login, maka jalankan perintah untuk export
  ...
  // mendefinisikan nama file hasil ekspor "Laporan Data Cassette Masuk.xls"
  header("Content-Disposition: attachment; filename=Laporan Data Cassette Masuk.xls");
?>
  ...
  <table border="1">
    <thead>
      <tr style="background-color:#6861ce;color:#fff">
        ...
        <th height="30" align="center" vertical="center"> Nama Cassette</th>
