...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  $html = '<!DOCTYPE html>
          <html>
          <head>
              <title>Laporan Data Cassette Masuk</title>
            <link href="../../assets/css/laporan.css" rel="stylesheet">
          </head>
          <body class="text-dark">
            <div class="text-center">
              <h2>LAPORAN DATA CASSETTE MASUK</h2>
  ...
  $dompdf->render();
  // menampilkan file PDF yang dihasilkan ke browser dan berikan nama file "Laporan Data Cassette Masuk.pdf"
  $dompdf->stream('Laporan Data Cassette Masuk.pdf', array('Attachment' => 0));
}
