<!-- Aplikasi Regesiter Elektronik Cassette PT. Bringin Gigantara
************************************************************************
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <meta name="description" content="Aplikasi Regesiter Elektronik Cassette PT. Bringin Gigantara" />
  <meta name="author" content="Code Null" />

  <-- Title -->
  <title>Aplikasi Regesiter Elektronik Cassette PT. Bringin Gigantara</title>

  <!-- Favicon icon -->
  <link rel="icon" href="assets/img/bgi10.png" type="image/x-icon" />
...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/bgi10.png" alt="Logo" width="95px"></div>
      <!-- judul -->
      <h3 class="text-center">Aplikasi Register Elektronik <br>PT.Bringin Gigantara</h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; PT.Bringin Gigantara - 2024</span>
         </div>
      </form>
    </div>
  </div>
